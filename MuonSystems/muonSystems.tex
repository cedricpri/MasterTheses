...
As we can see, in this case, and as expected, the geometry has a little impact on the deviation observed in the position and direction, along both the $x$ and $y$ axes. The study of this deviation will be the starting point of the determination of an unknown geometry placed between the detectors.
