...
For a given pipe having a geometry ($r = 17.2$ cm, $R = 20$ cm, $L = 50$ cm) and located in (0, 0, 0), thousands of muons have then been generated using Geant 4 and our Generator. The output distributions (the positions $x$ and $y$ and directions $v_x$ and $v_y$ after propagation, along with the deviation angles $\Delta \theta_x$ and $\Delta \theta_y$ defined in Equation~\ref{eq:deviation}) have then been obtained in this case in Figure~\ref{fig:genComp}.
...
\subfigure[Muon angular deviation at the bottom detector after propagation]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8cm, height=6cm]{figs/Atanpx-17p2vs17p2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8cm, height=6cm]{figs/Atanpy-17p2vs17p2.png}
\end{minipage} \hfill
}
\caption{Output measured position (on the top), direction (on the center) and actual $\Delta \theta$ deviation (on the bottom) measured on the bottom detector using the Geant 4 (in blue) simulation process and our Generator (in red), in $x$ (on the left) and $y$ (on the right).}
\label{fig:genComp}
\end{figure}
...
First of all, two different geometries can be considered for the propagation, usin our Generator, as shown in Figure~\ref{fig:gemComp}, for one pipe the same geometry as used for the validation process ($r = 17.2$ cm, $R = 20$ cm, $L = 50$ cm) and another one much thinner, having a geometry ($r = 18.8$ cm, $R = 20$ cm, $L = 50$ cm).
...
\subfigure[Muon angular deviation at the bottom detector after propagation]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8cm, height=6cm]{figs/Atanpx-Generator-17p2vs18p8.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8cm, height=6cm]{figs/Atanpy-Generator-17p2vs18p8.png}
\end{minipage} \hfill
}
\caption{Output measured position (on the top), direction (on the center) and actual $\Delta \theta$ deviation (on the bottom) measured on the bottom detector using our Generator and two different pipe geometries ($r = 17.2$ cm, in blue and $r = 18.8$ cm, in red), in $x$ (on the left) and $y$ (on the right).}
\label{fig:gemComp}
\end{figure}
